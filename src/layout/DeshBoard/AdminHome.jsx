    ...
    <div>
      ...
      <div className="stats shadow">
        <div className="stat">
          ...
          <div className="stat-value">${stats.revens || 0}</div>
        ...
        <div className="stat">
          ...
          <div className="stat-value">{stats.user || 0}</div>
          <div className="stat-desc">↗︎ Increased this month</div>
        </div>
        ...
        <div className="stat">
          ...
          <div className="stat-desc">↘︎ Slight decrease</div>
        </div>
      </div>
    </div>
  );
